...
<div class="container-fluid">
    <a class="navbar-brand" href="#">Abarrotes Online</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            ?>
							...
							<span  style="text-align: left; color: #000000;">Total en pesos</span>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="precio" type="hidden" id="precio" value="8" />
        <input name="titulo" type="hidden" id="titulo" value="Yogurt Fresa" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/yogurth.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Yogurth fresa</h5>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Pepsi 2.5L" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/pepsi.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Pepsi 2.5 litros</h5>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Coca cola 2L" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/coca.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">coca 2 Litros</h5>
